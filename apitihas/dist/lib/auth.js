...
exports.sendVerifyEmail = exports.getUserFromToken = exports.getPayloadByToken = exports.getJwtToken = void 0;
...
function getPayloadByToken(token) {
    const secret = process.env.JWT_SECRET;
    const payload = jsonwebtoken_1.default.verify(token, secret);
    return payload;
}
exports.getPayloadByToken = getPayloadByToken;
