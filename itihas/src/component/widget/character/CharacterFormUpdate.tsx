...
export const UpdateCharacterForm = ({
	...
	const onSubmitCreate = async (
		...
		// Здесь можно добавить логику для создания персонажа
		const character = {
			...values,
			id: Date.now(), // Временный ID, замените на реальный при необходимости
			createdAt: new Date().toISOString(),
			updatedAt: new Date().toISOString(),
			historyId: 1, // Замените на реальный ID истории
		};
