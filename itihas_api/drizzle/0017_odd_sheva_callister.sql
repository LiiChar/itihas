/*
You're trying to delete PRIMARY KEY(genre_id,history_id) from 'histories_to_genres' table
...
ALTER TABLE `histories_to_genres` ADD `id` integer PRIMARY KEY NOT NULL;