...
exports.pointsPageContent = exports.pagesContent = void 0;
...
exports.pagesContent = [
    {
        ...
        content: 'Ты чувствуешь, как холодный воздух обдувает лицо. Вокруг туман и тишина. Ты понимаешь, что находишься в Зоне.',
    ...
    },
    {
        ...
        content: 'Ты стоишь перед развилкой. Одна дорога ведет к старому заводу, другая - к заброшенной деревне. Куда пойти?',
        image: faker_1.faker.image.url(),
    },
    {
        historyId: 100,
        ...
        content: 'Завод выглядит заброшенным, но внутри что-то движется. Может быть, там сталкеры или мутанты.',
        image: faker_1.faker.image.url(),
    },
    {
        historyId: 100,
        ...
        content: 'Двое сталкеров обсуждают что-то. Один из них держит в руках странный артефакт.',
        image: faker_1.faker.image.url(),
    },
    {
        historyId: 100,
        ...
        content: 'Ты покидаешь завод и находишь заброшенный дом, где можно спрятаться.',
        image: faker_1.faker.image.url(),
    },
    {
        historyId: 100,
        ...
        content: 'Ты находишь древнюю карту Зоны. Она может указать на безопасные маршруты.',
        image: faker_1.faker.image.url(),
    },
    {
        historyId: 100,
        ...
        content: 'Аномалия сверкает, воздух вокруг нее искрится. Вдали что-то движется.',
        image: faker_1.faker.image.url(),
    },
    {
        historyId: 100,
        ...
        content: 'Кто-то попал в беду. Ты слышишь крик неподалеку. Решение за тобой.',
        image: faker_1.faker.image.url(),
    },
    {
        historyId: 100,
        ...
        content: 'Сталкер попал в аномалию и нуждается в помощи. Успеешь ли ты его спасти?',
        image: faker_1.faker.image.url(),
    },
    {
        historyId: 100,
        ...
        content: 'Сталкер благодарит тебя за спасение и предлагает свою помощь и информацию.',
        image: faker_1.faker.image.url(),
    },
];
exports.pointsPageContent = [
    {
        name: 'Идти вперёд',
        action: 'move(2);',
        pageId: 1,
