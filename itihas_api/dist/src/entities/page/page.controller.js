...
pageRouter.put('/:id/:currentPage/point', (0, validationMiddleware_1.validateData)(page_scheme_1.pagePointInsertScheme), (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const id = req.params.id;
        const currentPage = req.params.currentPage;
        const data = req.body;
        const user = (yield db_1.db.query.users.findMany())[0];
        const page = yield (0, page_service_1.createPagePoint)(parseInt(currentPage), data);
        return res.json(page).status(http_status_codes_1.StatusCodes.OK);
    }
    catch (error) {
        if (error instanceof Error)
...
pageRouter.put('/:id', (0, validationMiddleware_1.validateData)(page_scheme_1.pageInsertSchema), (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const id = req.params.id;
        const user = (yield db_1.db.query.users.findMany())[0];
        const data = req.body;
