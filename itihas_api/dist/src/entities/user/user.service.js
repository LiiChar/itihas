...
exports.changeStatusUser = exports.sendNotification = exports.logoutUser = exports.getListUsers = exports.getFullUsers = exports.getUser = exports.removeUser = exports.updateUser = exports.verifyEmail = exports.registerUser = exports.authificated = exports.loginUser = void 0;
...
const loginUser = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const isComparePassword = yield bcrypt_1.default.compare(password, userFind.password);
...
const authificated = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    console.log('req', req);
    res.json(true);
});
exports.authificated = authificated;
...
const getUser = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!user) {
        return res.json('User not exist').status(http_status_codes_1.StatusCodes.BAD_REQUEST);
    }
